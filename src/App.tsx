...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
        ...
        <div className="container-custom px-4">
          <div className="flex justify-between items-center">
            <div className="text-xl sm:text-2xl font-bold text-blue-900 flex items-center">
              <span className="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-2 sm:px-3 py-1 rounded-lg mr-2 text-sm sm:text-base">E</span>
              Eventador
            </div>
            ...
            <div className="hidden lg:flex space-x-8">
              ...
              <a href="#about" className="text-gray-700 hover:text-blue-600 transition-colors font-medium">How It Works</a>
            ...
            <div className="hidden lg:flex space-x-4">
              <button className="text-blue-900 hover:text-blue-700 font-medium px-4 py-2">Login</button>
      ...
      {/* Hero Section */}
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 to-blue-800 pt-16">
        ...
        <div className="container-custom relative z-10 px-4 py-12 sm:py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="text-white text-center lg:text-left">
              ...
              >
                <span className="font-medium text-sm sm:text-base">LIFE HAPPENS LIVE</span>
              </motion.div>
              ...
              >
                <p className="mb-3 sm:mb-4">
                  Imagine this: You dream of an unforgettable moment. A wedding that feels like magic. A conference that sparks revolutions. A birthday that echoes with joy. Now imagine bringing it to life without endless calls, vendor vetting, or sleepless nights.
                </p>
                <p className="mb-3 sm:mb-4 font-semibold text-yellow-300">That's Eventador.</p>
                <p>
                  We orchestrate your vision with a network of rigorously vetted partners. One platform. Two intuitive apps. Zero compromises.
                </p>
                <p className="mt-3 sm:mt-4 font-semibold text-yellow-300">Your moment. Our mastery.</p>
              </motion.div>
              ...
              >
                <div className="flex -space-x-2 sm:-space-x-4">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="w-8 h-8 sm:w-12 sm:h-12 rounded-full bg-blue-700 border-2 border-blue-900 flex items-center justify-center">
                      <span className="text-xs sm:text-lg font-bold">{i+1}</span>
                    </div>
                  ))}
                </div>
                <p className="text-blue-200 font-medium text-sm sm:text-base">Trusted by thousands of event planners</p>
              </motion.div>
            </div>
        ...
        <div className="container-custom px-4">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Eventador was born from a simple truth: Great events change lives — but planning them shouldn't drain yours.
            </p>
            <p className="text-base sm:text-lg text-gray-600 max-w-4xl mx-auto mt-4">
              Our founders watched brilliant ideas crumble under logistics. They saw talented vendors buried in administrative chaos. So we built a bridge.
            </p>
          </div>
          ...
          <div className="flex justify-center mb-8 sm:mb-12">
            <div className="bg-white p-1 rounded-full inline-flex border border-gray-200">
              <button 
                className={`px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-colors text-sm sm:text-base ${activeTab === 'host' ? 'bg-blue-600 text-white' : 'text-gray-700'}`}
                onClick={() => setActiveTab('host')}
              >
                For Hosts
              </button>
              <button 
                className={`px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-colors text-sm sm:text-base ${activeTab === 'vendor' ? 'bg-blue-600 text-white' : 'text-gray-700'}`}
                  ...
                  <div className="p-6 sm:p-8 lg:p-12">
                    <div className="bg-blue-50 p-4 sm:p-6 rounded-xl mb-6 sm:mb-8">
                      <p className="text-base sm:text-lg italic text-blue-900 mb-4">
                        "Eventador isn't an app; it's my secret weapon. I tap, book, and breathe. They handle the rest."
                      </p>
                      <div className="flex items-center">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-3 text-sm sm:text-base">U</div>
                        <div>
                          <p className="font-semibold text-blue-900 text-sm sm:text-base">User App Screenshot</p>
                          <p className="text-xs sm:text-sm text-blue-700">Clean interface showing "Booking Confirmed: Catering, Lighting, Venue Secured"</p>
                        </div>
                      </div>
                    </div>
                    
                    <h3 className="text-xl sm:text-2xl font-bold text-blue-900 mb-4 sm:mb-6">Your Vision, Digitally Perfected</h3>
                    
                    <div className="space-y-4 sm:space-y-6">
                      <div className="flex items-start">
                        <div className="bg-blue-100 text-blue-800 font-bold w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mr-3 sm:mr-4 mt-1 text-xs sm:text-sm">1</div>
                        <div>
                          <h4 className="font-semibold text-blue-900 mb-1 sm:mb-2 text-sm sm:text-base">Browse & Book</h4>
                          <p className="text-gray-600 text-sm sm:text-base">Browse, book, track, chat – all in your pocket. See real-time vendor arrival updates.</p>
                        </div>
                      </div>
                      
                      <div className="flex items-start">
                        <div className="bg-blue-100 text-blue-800 font-bold w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mr-3 sm:mr-4 mt-1 text-xs sm:text-sm">2</div>
                        <div>
                          <h4 className="font-semibold text-blue-900 mb-1 sm:mb-2 text-sm sm:text-base">Service Journey Tracker</h4>
                          <p className="text-gray-600 text-sm sm:text-base">Track all vendor progress in real-time through our app with "Vendor En Route!" notifications.</p>
                        </div>
                      </div>
                      
                      <div className="flex items-start">
                        <div className="bg-blue-100 text-blue-800 font-bold w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mr-3 sm:mr-4 mt-1 text-xs sm:text-sm">3</div>
                        <div>
                          <h4 className="font-semibold text-blue-900 mb-1 sm:mb-2 text-sm sm:text-base">Zero Headache</h4>
                          <p className="text-gray-600 text-sm sm:text-base">We orchestrate your vision with a network of rigorously vetted partners. One platform. Zero compromises.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 sm:p-8 lg:p-12">
                    <div className="bg-green-50 p-4 sm:p-6 rounded-xl mb-6 sm:mb-8">
                      <p className="text-base sm:text-lg italic text-green-900 mb-4">
                        "This is where serious partners thrive. We focus on craft; Eventador handles the crowd."
                      </p>
                      <div className="flex items-center">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-600 rounded-full flex items-center justify-center text-white font-bold mr-3 text-sm sm:text-base">V</div>
                        <div>
                          <p className="font-semibold text-green-900 text-sm sm:text-base">Vendor App Screenshot</p>
                          <p className="text-xs sm:text-sm text-green-700">Calendar view with "Confirmed Bookings" and "Real-Time Earnings" dashboard</p>
                        </div>
                      </div>
                    </div>
                    
                    <h3 className="text-xl sm:text-2xl font-bold text-blue-900 mb-4 sm:mb-6">Your Business, Simplified</h3>
                    
                    <div className="space-y-4 sm:space-y-6">
                      <div className="flex items-start">
                        <div className="bg-green-100 text-green-800 font-bold w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mr-3 sm:mr-4 mt-1 text-xs sm:text-sm">1</div>
                        <div>
                          <h4 className="font-semibold text-blue-900 mb-1 sm:mb-2 text-sm sm:text-base">Manage Everything</h4>
                          <p className="text-gray-600 text-sm sm:text-base">Manage bookings, payments, and client chats in one hub. Your business, simplified.</p>
                        </div>
                      </div>
                      
                      <div className="flex items-start">
                        <div className="bg-green-100 text-green-800 font-bold w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mr-3 sm:mr-4 mt-1 text-xs sm:text-sm">2</div>
                        <div>
                          <h4 className="font-semibold text-blue-900 mb-1 sm:mb-2 text-sm sm:text-base">Today's Events Map</h4>
                          <p className="text-gray-600 text-sm sm:text-base">Optimized travel routes and real-time earnings dashboard with "Today's Events" tracking.</p>
                        </div>
                      </div>
                      
                      <div className="flex items-start">
                        <div className="bg-green-100 text-green-800 font-bold w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mr-3 sm:mr-4 mt-1 text-xs sm:text-sm">3</div>
                        <div>
                          <h4 className="font-semibold text-blue-900 mb-1 sm:mb-2 text-sm sm:text-base">Focus on Craft</h4>
                          <p className="text-gray-600 text-sm sm:text-base">We handle the crowd while you focus on delivering exceptional experiences.</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-12 sm:mt-16 text-center">
            <h3 className="text-2xl sm:text-3xl font-bold text-blue-900 mb-6 sm:mb-8">We believe in:</h3>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {values.map((value, index) => (
                <div key={index} className="bg-white p-4 sm:p-6 rounded-xl shadow-lg">
                  <div className={`w-12 h-12 sm:w-16 sm:h-16 ${value.bgColor} rounded-full flex items-center justify-center mx-auto mb-4`}>
                    <span className="text-xl sm:text-2xl">{value.icon}</span>
                  </div>
                  <h4 className="text-lg sm:text-xl font-bold text-blue-900 mb-2">{value.title}</h4>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="container-custom px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 mb-12 sm:mb-16">
            {/* Goals */}
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-blue-900 mb-6 sm:mb-8">Our Goals</h3>
              <div className="space-y-6 sm:space-y-8">
                {goals.map((goal, index) => (
                  <div key={index} className="flex items-start">
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 ${goal.bgColor} rounded-full flex items-center justify-center mr-4 sm:mr-6 mt-1`}>
                      <span className="text-xl sm:text-2xl">{goal.icon}</span>
                    </div>
                    <div>
                      <h4 className="text-lg sm:text-xl font-bold text-blue-900 mb-1 sm:mb-2">{goal.title}</h4>
            ...
            {/* Values */}
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-blue-900 mb-6 sm:mb-8">Our Values</h3>
              <div className="space-y-6 sm:space-y-8">
                {values.map((value, index) => (
                  <div key={index} className="flex items-start">
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 ${value.bgColor} rounded-full flex items-center justify-center mr-4 sm:mr-6 mt-1`}>
                      <span className="text-xl sm:text-2xl">{value.icon}</span>
                    </div>
                    <div>
                      <h4 className="text-lg sm:text-xl font-bold text-blue-900 mb-1 sm:mb-2">{value.title}</h4>
                      <p className="text-gray-600 text-sm sm:text-base">{value.description}</p>
                    </div>
                  </div>
                ))}
      ...
      <section id="testimonials" className="py-16 sm:py-20 bg-gradient-to-br from-blue-900 to-blue-800 text-white">
        <div className="container-custom px-4">
          <div className="text-center mb-12 sm:mb-16">
              ...
              >
                <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-8">
                  <div className="flex-1">
                    ...
                    <div>
                      <h4 className="font-bold text-base sm:text-lg">{testimonials[currentTestimonial].name}</h4>
            ...
            <div className="flex justify-center mt-6 sm:mt-8 space-x-2">
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full ${currentTestimonial === index ? 'bg-white' : 'bg-white/30'}`}
      ...
      <section id="showcase" className="py-16 sm:py-20 bg-white">
        <div className="container-custom px-4">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Gallery Curation: High-res event photos with captions highlighting Eventador's role
            </p>
          </div>
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex justify-between items-start mb-3 sm:mb-4">
                    <h3 className="text-lg sm:text-xl font-bold text-blue-900">{event.title}</h3>
                    <span className={`text-xs sm:text-sm font-medium px-2 sm:px-3 py-1 rounded-full ${event.categoryColor}`}>
                      {event.category}
                    </span>
                  </div>
          ...
          <div className="mt-16 sm:mt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 sm:p-8 rounded-2xl">
                <h4 className="text-xl sm:text-2xl font-bold text-blue-900 mb-4">User App</h4>
                <p className="text-gray-700 mb-6 text-sm sm:text-base">
                  Browse, book, track, chat – all in your pocket. See real-time vendor arrival updates.
                </p>
                ...
                <p className="text-xs sm:text-sm text-blue-700 mt-3 sm:mt-4 italic">
                  Screenshot: "Service Journey" tracker showing "Vendor En Route!"
                </p>
              </div>

              <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 sm:p-8 rounded-2xl">
                <h4 className="text-xl sm:text-2xl font-bold text-green-900 mb-4">Vendor App</h4>
                <p className="text-gray-700 mb-6 text-sm sm:text-base">
                  Manage bookings, payments, and client chats in one hub. Your business, simplified.
                </p>
                <div className="relative">
                  <img 
                    src={vendorApp} 
      ...
      {/* Pricing Section - Bolt-style simple pricing */}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
              <div className="bg-blue-50 p-8 text-center">
                <h3 className="text-2xl font-bold text-blue-900 mb-2">For Hosts</h3>
                <div className="text-4xl font-bold text-blue-800 mb-2">Free</div>
                <p className="text-gray-600">No upfront costs</p>
              </div>
              <div className="p-8">
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
                    <div className="text-green-500 mr-3">✓</div>
                    <span>Access to all vendors</span>
                  </li>
                  <li className="flex items-center">
                    <div className="text-green-500 mr-3">✓</div>
                ...
                <p className="text-center text-gray-600 mb-6">
                  <span className="font-semibold">5% service fee</span> on successful bookings
                </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl border-2 border-blue-500 overflow-hidden transform scale-105 relative">
              <div className="absolute top-4 right-4 bg-yellow-400 text-blue-900 font-bold px-3 py-1 rounded-full text-sm">
                MOST POPULAR
              </div>
              <div className="bg-blue-500 p-8 text-center">
                <h3 className="text-2xl font-bold text-white mb-2">For Vendors</h3>
                <div className="text-4xl font-bold text-white mb-2">15%</div>
                <p className="text-blue-100">Per completed booking</p>
              </div>
              <div className="p-8">
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
              <div className="bg-blue-50 p-8 text-center">
                ...
                <div className="text-4xl font-bold text-blue-800 mb-2">Custom</div>
        ...
        <div className="container-custom relative z-10 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
              We take the weight off your shoulders, so you can carry the moment in your heart.
            </h2>
      ...
      {/* Final CTA - Bolt-style prominent section */}
      <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-800">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-blue-200 mb-10 max-w-2xl mx-auto">
            Join thousands of event professionals who trust Eventador to make their vision a reality.
          </p>
          <div className="flex flex-wrap justify-center gap-6">
            <button className="bg-white text-blue-900 font-bold px-8 py-4 rounded-full hover:shadow-lg hover:bg-blue-50 transition-all">
      ...
      {/* Footer - Enhanced with Bolt-style layout */}
      <footer className="bg-blue-950 text-white py-16">
        <div className="container-custom">
          <div className="grid md:grid-cols-5 gap-10">
            <div className="md:col-span-2">
              <div className="text-2xl font-bold mb-4 flex items-center">
                <span className="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-3 py-1 rounded-lg mr-2">E</span>
                Eventador
              </div>
              <p className="text-blue-300 mb-6 max-w-md">
                Where visionary hosts meet trusted curators. Making event planning effortless since 2023.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-blue-300">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Vendor Resources</a></li>
          ...
          <div className="border-t border-blue-900 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-blue-400 mb-4 md:mb-0">&copy; 2024 Eventador. All rights reserved.</p>
            <div className="flex space-x-6">
              <a href="#" className="text-blue-400 hover:text-white transition-colors">Privacy Policy</a>
              <a href="#" className="text-blue-400 hover:text-white transition-colors">Terms of Service</a>
              <a href="#" className="text-blue-400 hover:text-white transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </footer>
